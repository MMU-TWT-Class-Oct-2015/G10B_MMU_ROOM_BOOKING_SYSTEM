...
<body>
<ul class="header">
  <li class="headerli"><a class="headera" href="admviewrecords.php">View Booking Records</a></li>
...
print("</tr>");
 ...
 <form  align="right" action="admbooking.php" method="POST" >
